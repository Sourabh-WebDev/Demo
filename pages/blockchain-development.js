...
const Blockchaintechnologies = () => {
    ...
    return (
        ...
        <Layout>
            <PageBanner pageName={"Blockchain Technologies"} img={"assets/images/newweb/BD.jpg"} />
                ...
                <div className="container">
                    <div className="row large-gap">
                        <div className="col-lg-6">
                            <div className="course-details-content">
                                <div className="course-header">
                                    <span className="category">Blockchain Technologies</span>
                                ...
                                <div className="image mb-35">
                                    <img
                                        width={768}
                                        src="assets/images/newweb/BCD.jpg"
                                        alt="Course Details"
                                    />
                                </div>
                                <p>
                                    Thanks to its ability to execute secure and efficient time-stamped transactions, businesses are adopting Blockchain-based technologies at unprecedented speed. PwC suggests that blockchain technology will add USD1.76 trillion to the global economy by 2030 – now’s the time for early adopters to get ahead of the curve.​ we provide assistance in creating the necessary audit trails, Data Management processes, and business models to ensure the successful deployment of blockchain technology.
                                </p>
                        ...
                        <div className="col-lg-6">
                            ...
                            <h3 className="mt-40">Our services​ ​</h3>
                            {/* <ul className="list-style-two mb-45">
                            ...
                            <div>
                                <h3 className="mt-40">NFT Marketplace Development ​</h3>
                                <p> We build solutions that allow users to mint tokens for their virtual or real-world assets taking care of everythingfrom planning and execution to testing and delivery.</p>
                            </div>
                            <div>
                                <h3 className="mt-40">Blockchain Application Development​ ​</h3>
                                <p>We help you deploy Blockchain for business-wide transactions in a secure and transparent environment, reducingoperational costs and business overheads.</p>
                            </div>
                            <div>
                                <h3 className="mt-40">Apps Development​</h3>
                                <p>We build decentralized app development and smart contract solutions that run on blockchain technology, focusing on​increased security and transparency.</p>
                            </div>
                            <div>
                                <h3 className="mt-40">Smart Contract Development​</h3>
                            </div>
