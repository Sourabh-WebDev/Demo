    ...
    <div className="row">
      <div className="col-lg-6">
        {faqsLeft.map((faq, i) => (
          ...
          >
            <p>
              Apexpath Pvt Ltd adipiscing elit sed do eiusmod tempor
          ...
          <div className="row large-gap align-items-center justify-content-between">
            <div className="col-lg-5">
              <div className="faqs-form-content rmb-65 wow fadeInRight delay-0-2s">
                ...
                <p>
                  Apexpath are a technology driven and innovation oriented progressive company which provides a distinct
