...
const databaseMgmt = () => {
    ...
    return (
        ...
        <Layout>
            <PageBanner pageName={"Database Management"} img={"assets/images/newweb/DBS.jpg"} />
                ...
                <div className="container">
                    <div className="row large-gap">
                        <div className="col-lg-6">
                            <div className="course-details-content">
                                <div className="course-header">
                                    <span className="category">Database Management</span>
                                ...
                                <div className="image mb-35">
                                    <img
                                        width={768}
                                        src="assets/images/newweb/DBMS.jpg"
                                        alt="Course Details"
                                    />
                                </div>
                                <p>
                                    From web scraping to software development solutions, database maintenance plays an important role. To get to the valuable insights that your data hides, we apply both proven statistical

                                    methods and elaborate machine learning algorithms, including such intricate

                                    techniques as deep neural networks with 10+ hidden layers.
                                </p>


                                <h3 className="mt-40">Methods and Technologies We Use</h3>
                        ...
                        <div className="col-lg-6">
                            ...
                            {/* <h3 className="mt-40">Database Management Points</h3>
                            <ul className="list-style-two mb-45">
                            ...
                            <div>
                                <h3 className="mt-40">Business needs analysis​</h3>
                                <p>Outlining business objectives to meet with data science. Defining issues with the existing data science solution (if any). Deciding on data science deliverables.​</p>
                            </div>
                            <div>
                                <h3 className="mt-40">Data preparation​</h3>
                                <p>Determining data source for data science.​ Data collection, transformation and cleansing.​</p>
                            </div>
                            <div>
                                <h3 className="mt-40">Machine learning (ML) model design and development.​</h3>
                                <p>Choice of the optimal data science techniques and methods.​Defining the criteria for the future ML model(s) evaluation.​ ML model development, training, testing and deployment.​​</p>
                            </div>
                            <div>
                                <h3 className="mt-40">Delivering data science output in an agreed format​</h3>
                                <p>Data science insights ready for business use in the form of reports and dashboards.​Custom ML-driven app for self-service use (optional).​ ML model integration into other applications (optional).​</p>
                            </div>
