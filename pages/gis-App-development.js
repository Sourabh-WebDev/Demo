                    ...
                    <div className="row large-gap">
                        <div className="col-lg-6">
                            <div className="course-details-content">
                                ...
                                <p>
                                    GIS services have proven to be an indispensable tool to analyze data for mapping and visualizing environmental data.

                                    An interoperable GIS database of the world that covers almost all topics is a goal motivated by the growth of GIS as a platform for data exchange and collaboration.
                        ...
                        <div className="col-lg-6">
                            ...
                            <h3 className="mt-40">GIS App Development Points</h3>
                            <ul className="list-style-two mb-45">
...
export default gisAppDevelopment