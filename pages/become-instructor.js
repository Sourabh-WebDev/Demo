              ...
              <div className="bebefit-work-steps wow fadeInLeft delay-0-2s">
                ...
                <div className="work-step-item">
                  ...
                  <div className="content">
                    ...
                    <p>
                      At Apexpath we strictly follow a full life cycle development process from requirements definition and specification, architecture, process & commencement of the project & the Life cycle involves the complete process from the conceptual feasibility to Roll out of a project.
                    </p>
                  </div>
                </div>
                <div className="work-step-item">
                ...
                <ul className="list-style-three pt-10">
                  ...
                  <li>
                    <div className="content">
                      ...
                      <p>
                        Apexpath possesses a boisterous man power having a perfect balance of experience & Expertise.
                      </p>
                    </div>
                  </li>
                </ul>
